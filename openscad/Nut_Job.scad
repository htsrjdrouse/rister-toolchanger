...
{
	//translate([0,0,29])rotate([0,180,0])ferrule();
	...
	translate([0,0,21])#cylinder(d=5.2,h=2,$fn=100);
	}
	cylinder(d=3.05,h=60,$fn=100);
	translate([0,0,29])rotate([0,180,0])ferrule();
	}
}
