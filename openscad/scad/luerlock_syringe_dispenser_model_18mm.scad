...
pipette_holder_4tip_luerlock_lid_18mm();
pipette_assembly();
*/
//pipette_assembly();
...
/*
for(i=[0:3]){
translate([(i*18)+302.8,430.5,-17-8-4+315])rotate([0,180,0]){
luerlock_connector();
}
}
...
translate([(i*18)+302.8,430.5,-17-8-4+315])rotate([0,180,0]){
    ...
    translate([0,0,12])rotate([0,180,0])color("lightblue")cylinder(d2=6.5,d1=5,h=13,$fn=30);
...
//luerlock_pipette_tipcase_holder_18mm();
//luerlock_tipcase_makesquare_18mm();

/*
translate([84,-14,-40]){
translate([348.5,396+50-3.5,374-120+30])rotate([0,0,90]){translate([-15,0,0])luerlock_pipette_tipcase_holder_18mm();}

translate([446-100,396,374+40])rotate([0,0,90]){
translate([-30-164.5,2,-151.5+130-130])rotate([0,-90,0])luerlock_tipcase_makesquare_18mm();
translate([-30-164.5+105,2,-151.5+130-130])rotate([0,-90,0])luerlock_tipcase_makesquare_18mm();
translate([0-0.5,0-2,-130]){
translate([-15-35,8+19+16,-9])rotate([0,90,0])tslot20(100);
translate([-15-35,8-46-16,-9])rotate([0,90,0])tslot20(100);
}
}
...
//translate([327.5,430,260-4])rotate([0,180,90])luer_lock_microwell();
...
/*
translate([215,-120,80]){
translate([400-70+3-210,426.5+3+124,330-3+50-124])rotate([0,0,-90])color("lime")luerlock_dispenser_assy_remover();
}

pipette_18g_set();
translate([-8.5,4,-28]){
translate([324.5+18.6,427,300-14])rotate([0,180,90])luer_lock_case_lid_18mm();
luerlock_nozzle_case_18mm();
translate([0,0,0])luerlock_nozzle_bottom_18mm();
}
*/
/*
translate([320,420,227])rotate([0,180,0])difference(){
translate([8.4,4,31])import("../doctor_blade_4pipette_18mm.stl");
//translate([14,2,-62.5])#cube([10,13,10]);
//translate([14-74.5,2,-62.5])#cube([10,13,10]);
}
*/
//translate([-0.5-1,-0.7,0])rotate([0,180,180])pipette_holder_4tip_luerlock();
...
translate([339+10.2,430+1,295+6-7])rotate([0,180,90])color("lightgreen")translate([0,-1.9,10.5+12+1]){
for(i=[0:3]){
translate([0,-5.7+(i*18),-17-8-4])rotate([0,180,0]){
luerlock_connector();
pipette_13g();
cylinder(d=3,h=60,$fn=100);
if(i==0){
translate([0,0,60])rotate([-6,-19,0])cylinder(d=3,h=35,$fn=100);
translate([-10,3.5+0.5,60+28])rotate([0,0,0])cylinder(d=3,h=70,$fn=100);
translate([-9,3.5+10-9.5,60+28+69])rotate([-11,-52,0])cylinder(d=3,h=83,$fn=100);
}
if(i==1){
translate([0,0,60])rotate([-10,-20,0])cylinder(d=3,h=33,$fn=100);
translate([-10,5,60+48.5-20])rotate([0,0,0])cylinder(d=3,h=65,$fn=100);
translate([-11.3,5,60+50+42])rotate([2,-49,0])cylinder(d=3,h=82,$fn=100);
}
if(i==2){
translate([0,0,60])rotate([-10,-19,0])cylinder(d=3,h=34,$fn=100);
translate([-10,6,60+50-20])rotate([0,0,0])cylinder(d=3,h=67,$fn=100);
translate([-10.5,6,60+50+46])rotate([14,-52,0])cylinder(d=3,h=80,$fn=100);
}
if(i==3){
translate([0,0,60])rotate([-12,-19,0])cylinder(d=3,h=34,$fn=100);
translate([-10,7,60+50-20])rotate([0,0,0])cylinder(d=3,h=67,$fn=100);
translate([-10.5,7,60+50+46])rotate([26,-53,0])cylinder(d=3,h=86,$fn=100);
}
...
module pipette_holder_4tip_luerlock_lid_18mm(){
difference(){
...
difference(){
union(){
translate([0+0.5,4.5,-3])rounded_box_minkowski(size = [10+4+5, 20+2+6.5+6+10+5+5+19, 13], radius = 2, center = true);
translate([0+0.5-7,4.5,-3])rounded_box_minkowski(size = [10+4+5, 20+2+6.5+6+10+5+5+19, 13], radius = 2, center = true);
}
translate([0,4.5,0])rounded_box_minkowski(size = [10+4, 20+2+6.5+6+10+5+19, 10], radius = 2, center = true);
translate([0-6.7,4.5,0])rounded_box_minkowski(size = [10+4, 20+2+6.5+6+10+5+19, 10], radius = 2, center = true);
translate([0+1,4.5,0])rounded_box_minkowski(size = [10+4, 20+2+6.5+6+10+5+19, 10], radius = 2, center = true);
for(i=[-2:2]){
for(j=[-2:2]){
...
module pipette_18g_set(){

translate([-5.5-0.7-1.3,0,0-4+6.5-24]){
for(i=[0:3]){
//translate([319+i*11.5,427,309])rotate([0,180,0])tuberculin_syringe_015ml();
translate([310.5+i*18,431,309-30])rotate([0,0,0])pipette_18g();
}
}
...
module linearactuator_pipette_holder_4pipette_luerlock_18mm(){
...
difference(){
union(){
translate([0-6,4.5,3])rounded_box_minkowski(size = [10+4, 20+2+6.5+6+15+19, 13], radius = 2, center = true);
translate([0,4.5,3])rounded_box_minkowski(size = [10+4, 20+2+6.5+6+15+19, 13], radius = 2, center = true);
translate([0+1,4.5,3])rounded_box_minkowski(size = [10+4, 20+2+6.5+6+15+19, 13], radius = 2, center = true);
}
...
module luerlock_tipcase_makesquare_18mm(){
translate([0-0.5,0-2,-130]){
difference(){
translate([-9,-32-5-10,-14])cube([14,64+20+10+19,5]);
translate([0,0,0]){
translate([0,19+5+9.2,0]){
translate([-2,23,-22])cylinder(d=5.2,h=42,$fn=100);
translate([-2,23,-11])cylinder(d=10.5,h=20,$fn=100);
}
translate([0,-46-5-12.8,0]){
translate([-2,23,-22])cylinder(d=5.2,h=42,$fn=100);
translate([-2,23,-11])cylinder(d=10.5,h=20,$fn=100);
}
}
...
translate([0-0.5,0-2,-130]){
difference(){
translate([-9,-32-5,-14])cube([14,64+20+10,5]);
translate([0,0,0]){
translate([0,19+5,0]){
translate([-2,23,-22])cylinder(d=5.2,h=42,$fn=100);
translate([-2,23,-11])cylinder(d=10.5,h=20,$fn=100);
...
difference(){
union(){
translate([-7+5-3,0,-.75])rounded_box_minkowski(size = [17+20, 20+2+6.5+30+15+16+8, 4], radius = 0.5, center = true);
...
translate([-23+3.5,0,-.75-7.5-5-9-5])rounded_box_minkowski(size = [15, 20+2+6.5+22+12, 4+25+18+10], radius = 0.5, center = true);
}
#translate([-2+5,0+33,-.75])rotate([30,0,0])rounded_box_minkowski(size = [19+5, 20+2+6.5+12+10+16+10, 7], radius = 2, center = true);
#translate([-2+5,0-33,-.75])rotate([-30,0,0])rounded_box_minkowski(size = [19+5, 20+2+6.5+12+10+16+10, 7], radius = 2, center = true);
translate([-2+5,0,-.75])rounded_box_minkowski(size = [19+5, 20+2+6.5+12+10+16+10, 7], radius = 2, center = true);
#translate([-18.8,17.5,-.75-5-45-20])cylinder(d=6,h=185,$fn=100);
#translate([-18.8,-17.5,-.75-5-45-20])cylinder(d=6,h=185,$fn=100);
#translate([-18.8,17.5,-.75-5-22+4-18-10])cylinder(d=11,h=85,$fn=100);
#translate([-18.8,-17.5,-.75-5-22+4-18-10])cylinder(d=11,h=85,$fn=100);
...
asub= 6;
translate([0,0,-13.5]){
translate([-10.5+j/2+asub/2,-16.5+i/2+sub/2-3,5])rounded_cube([8+4+4+4-asub, 10+4+15+10+4+8.5-sub+6, 7.5-1+4+2+6.5], corner_radius);
translate([-10.5+i/2+asub/2,-16.5+j/2+sub/2-3,5])rounded_cube([8+4+4+4-asub, 10+4+15+10+4+8.5-sub+6, 7.5-1+4+2+6.5], corner_radius);
translate([-10.5+i/2+asub/2,-16.5+j/2+sub/2-3,-5-2])rounded_cube([8+4+4+4-asub, 10+4+15+10+4+8.5-sub+6, 7.5-1+4+2+6.5], corner_radius);
//for doctor blade
translate([-10.5+j/2+asub/2,-16.5+i/2+sub/2-4,5])rounded_cube([6, 10+4+15+10+4+8.5-sub+8, 7.5-1+4+2+6.5], corner_radius);
translate([-10.5+i/2+asub/2,-16.5+j/2+sub/2-4,5])rounded_cube([6, 10+4+15+10+4+8.5-sub+8, 7.5-1+4+2+6.5], corner_radius);
translate([-10.5+i/2+asub/2,-16.5+j/2+sub/2-4,-5-2])rounded_cube([6, 10+4+15+10+4+8.5-sub+8, 7.5-1+4+2+6.5], corner_radius);
}
}
/*
...
module luerlock_pipette_tipcase_holder_18mm(){
difference(){
union(){
color("peru"){
...
//translate([-4-2-2-2,-5-2-15-6-2,-2-16-16-4-2-4])
translate([2,0,0]){
translate([-10.5+j/2,-16.5+i/2-7.5,5])rounded_cube([8+4+4+4, 10+4+15+10+4+8.5+17, 7.5-1+4+2+6.5], corner_radius);
translate([-10.5+i/2,-16.5+j/2-7.5,5])rounded_cube([8+4+4+4, 10+4+15+10+4+8.5+17, 7.5-1+4+2+6.5], corner_radius);
sub=9;
asub= 6;
translate([0,0,-13.5]){
...
//for doctor blade
translate([-10.5+j/2+asub/2,-16.5+i/2+sub/2-4-11.5,5])rounded_cube([6, 10+4+15+10+4+8.5-sub+8+24, 7.5-1+4+2+16.5], corner_radius);
translate([-10.5+i/2+asub/2,-16.5+j/2+sub/2-4-11.5,5])rounded_cube([6, 10+4+15+10+4+8.5-sub+8+24, 7.5-1+4+2+6.5], corner_radius);
translate([-10.5+i/2+asub/2,-16.5+j/2+sub/2-4-11.5,-5-2])rounded_cube([6, 10+4+15+10+4+8.5-sub+8+24, 7.5-1+4+2+6.5], corner_radius);
}
}
/*
translate([-6.25+j/2,-5-2-7.5+2.7+i/2,-2-13])rounded_cube([12, 10+4+10, 7.5+10], corner_radius);
...
module luerlock_nozzle_bottom_18mm(){
difference(){
corner_radius = 1;  // Adjust this value to change roundness
...
translate([337-12.5+18,427,300-15+0.2+0.8-20])rotate([0,180,90])translate([-4-2-2-2,-5-2-15-6-2,-2-16-16-4-2-4])rounded_cube([8+4+4+4, 10+4+15+10+4+8.5+17, 7.5-1+4+2+6.5], corner_radius);
translate([337-12.5,427,300-15+0.2+0.8+16-16.65])rotate([0,180,90])translate([0,0,-15])scale([1.02,1.02,1]){
#translate([-4-2-2,-5-15-7.5-18.5,-2-15-1-2+2.9])rounded_cube([8+4+4, 10+15+5+4+8.5+4.3+17.7, 17+5-5], corner_radius);
cylinder(d1=3,d2=2.5,h=5,$fn=50);
translate([0,0,-5])cylinder(d=5,h=5,$fn=50);

translate([0,0,15.3]){
translate([0,0,-15-12.5+1+9]){
translate([0,3.5+4+10-1.9-3,-2])rotate([0,90,0])cylinder(d=2.5,h=40,$fn=50);
translate([0,-3.5-15-7+2-16.75,-2])rotate([0,-90,0])cylinder(d=2.5,h=40,$fn=50);

//translate([0,3.5+4+10-1.9-11,0])rotate([0,90,0])cylinder(d=2.5,h=40,$fn=50);
//translate([0,3.5+4+10-1.9-18,0])rotate([0,90,0])cylinder(d=2.5,h=40,$fn=50);
...
translate([-2,0,0]){
//luerlock_male();
translate([319,427,309-11.048])rotate([0,180,0])luerlock_male();
translate([319+(18*1),427,309-11.048])rotate([0,180,0])luerlock_male();
translate([319+(18*2),427,309-11.048])rotate([0,180,0])luerlock_male();
translate([319+(18*3),427,309-11.048])rotate([0,180,0])luerlock_male();
}
}
}
}
...
module luerlock_nozzle_case_18mm(){
difference(){
translate([337-12.5,427,300-15])rotate([0,180,90])luerlock_nozzle_case_pre();
//translate([319+10.2-3,427-10,309-15])cube([30,30,40]);
translate([-5.5,0,0-4+6.5]){
...
#translate([319+(18*i),427,309-20])rotate([0,180,0])translate([0,0,0])rotate([0,180,0])color("pink")cylinder(d2=8.25,d1=8.25,h=6.5+22,$fn=50);
...
module luer_lock_case_lid_18mm(){
difference(){
corner_radius = 1;  // Adjust this value to change roundness
translate([-4-2-2-2,-5-2-15-6-2-6-5+7.5,-2-16-16-4-2-4+5])rounded_cube([8+4+4+4, 10+4+15+10+4+8.5+12+18.5+8.5-14, 7.5-1+4+2+6.5-5], corner_radius);
#translate([0,12,-15-12.5+2]){
translate([0-20,3.5+4+10-1.5+3.5,-2])rotate([0,90,0])cylinder(d=2.5,h=40,$fn=50);
translate([0+20,-3.5-15-7+1.5-10.5,-2])rotate([0,-90,0])cylinder(d=2.5,h=40,$fn=50);
}
translate([0,0,-15])scale([1.02,1.02,1]){
translate([-4-2-2,-5-15-7.5,-2-15-1-2+2.9])rounded_cube([8+4+4, 10+15+5+4+8.5+4.3+17.5, 17+5-5], corner_radius);
cylinder(d1=3,d2=2.5,h=5,$fn=50);
translate([0,0,-5])cylinder(d=5,h=5,$fn=50);
}
...
#translate([0,-i*18+0.8,-23-2.7+1])scale([1.05,1.05,1])rotate([0,180,0])p200_lts_holder();
translate([0,-i*18+0.8,-23-2.7-13+1])cylinder(d=7.5,h=20,$fn=30);
}
translate([0,2-1.3,0+1])for(i=[-1:2]){
//#translate([0,-i*11.5+0.8,-40+2-2.01-4.3])cylinder(d1=9.25,d2=4,h=8,$fn=50);
#translate([0,-i*18+0.8,-40+2-2.01-4.3])cylinder(d1=9.25,d2=4,h=8,$fn=50);
}
}
...
difference(){
corner_radius = 1;  // Adjust this value to change roundness
translate([-4-2-2-2-4,-5-2-15-6-2-1-7,-2-16-16-4-2-4-10])rounded_cube([8+4+4+4+8, 10+4+15+10+4+8.5+6+14, 7.5-1+4+2+6.5+10], corner_radius);
/*
*/
...
translate([0,2,0])for(i=[-1:2]){
//translate([0,-i*11.5+0.8,-23-2.7])scale([1.05,1.05,1])rotate([0,180,0])p200_lts_holder();
#translate([0,-i*sp+0.8,-23-2.7-13])cylinder(d1=8.5,d2=2,h=10+10,$fn=30);
}
translate([0,2,0])for(i=[-1:2]){
translate([0,-i*sp+0.8,-40+2-2.01-4.3])cylinder(d1=11.25,d2=4,h=8+10,$fn=50);
}
}
}
}
...
union(){
// Main collar body
translate([-4-2-2+0.3,-5-2-15-6+0.2+0.2-19,-2-15-4-12])rounded_cube([8+4+4-0.6, 10+4+15+18.5-0.4-0.4+18.5, 6.5+1+16-6], corner_radius);
}
#translate([0,0,-15-12.5+1]){
translate([0-20,3.5+4+10-4.6,-2])rotate([0,90,0])cylinder(d=1.7,h=40,$fn=50);
translate([0+20,-3.5-15-7+1.5-17.1,-2])rotate([0,-90,0])cylinder(d=1.7,h=40,$fn=50);
}
#translate([0,0,-15-12.5+1+9]){
translate([0,3.5+4+10-1.5-3.2,-2])rotate([0,90,0])cylinder(d=1.7,h=40,$fn=50);
translate([0,-3.5-15-7+1.5-17.1,-2])rotate([0,-90,0])cylinder(d=1.7,h=40,$fn=50);
}
/*
*/
}
...
module luerlock_male(){


//translate([0,-5.8+11.5*i-4.9,-21.4-3.5+2])
cylinder(d=11.2,h=8,$fn=30);
cylinder(d=6.6,h=18,$fn=30);
