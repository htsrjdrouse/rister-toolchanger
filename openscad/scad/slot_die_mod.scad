...
translate([162,220,11]){
/*
color("white")translate([357-(18*1),431.5,290])luerlock_connector_slotdie();
color("lime")translate([357-(18*1),431.5,290])pipette_10g_slotdie();
color("white")translate([357-(18*2),431.5,290])luerlock_connector_slotdie();
color("pink")translate([357-(18*2),431.5,290])pipette_10g_slotdie();
*/

translate([0,0,5.9]){
color("white")translate([357-(18*2)-0.5,431.5,300])luerlock_connector_slotdie();
color("pink")translate([357-(18*2)-0.5,431.5,300])pipette_10g_slotdie();
color("lime")translate([357-(18*2)-0.5,431.5,300])airknife();
}
translate([0,13,5.9]){
color("white")translate([357-(18*2)-0.5,431.5,300])luerlock_connector_slotdie();
color("pink")translate([357-(18*2)-0.5,431.5,300])pipette_10g_slotdie();
color("peru")translate([357-(18*2)-0.5,431.5,300])finger();
}

linearactuator_finger_airknife();
translate([0,-1,5.9])linearactuator_pipette_holder_1by1pipette_luerlock_18mm_slotdie();
}
...
translate([0,0,-31])cylinder(d2=10,d1=6,h=32,$fn=100);
}
}
pipette_10g_slotdie();
translate([0,0,-31])rotate([0,-90,0])cylinder(d=3,h=5,$fn=50);
translate([0,0,-32])rotate([0,0,0])cylinder(d=3,h=15,$fn=50);
}
}
...
translate([0,0,-13]){
//cylinder(d=8,h=3,$fn=100);
translate([0,0,-31])cylinder(d2=10,d1=2,h=42,$fn=100);
}
}
}
...
//slotdie(60, 24, 12, 3, 13, 0.2, 18.5, 20);
//translate([357,432,260])rotate([0,0,90])slotdie_assy_pp_single();
//translate([357,432,260])rotate([0,0,90])slotdie_assy_pp_single_13wider();
//slotdie_assy_pp_single_placeholder_13wider();
/*
translate([357+18,432,260])rotate([0,0,90])color("pink")difference(){
slotdie_assy_pp_single_placeholder();
translate([-10,5.7,-50])cube([20,20,50]);
}
*/
...
module slotdie_assy_pp_single_placeholder_13wider(){
translate([357+18,432,260])rotate([0,0,90])color("pink")difference(){
slotdie_assy_pp_single_placeholder();
translate([-10,5.7,-50])cube([20,20,50]);
}
...
module slotdie_assy_pp_single_13wider(){
difference(){
union(){
slot_die_4channel_p200_dispenser_single_13wider();
}
translate([0,0,1])for(i=[0:0]){
translate([6.8,0+i*18,-15-4-5])cylinder(d=3,h=8+5+5,$fn=100);
translate([6.8,0+i*18,-30-3])cylinder(d=5.2,h=11,$fn=100);
translate([6.8-13.7,0+i*18,-15-4-5])cylinder(d=3,h=8+5+5,$fn=100);
translate([6.8-13.7,0+i*18,-30-3])cylinder(d=5.2,h=11,$fn=100);
}
...
module slot_die_4channel_p200_dispenser_single_13wider(){
rotate([0,90,0]){
...
translate([50,22.9,0])rotate([0,90,0])translate([-10,-30-1.9,-44])rounded_cube([20, 68.5+3.5-54, 19], corner_radius);
translate([-9-1-2,-11,10])rotate([0,90,0])rounded_cube([20, 76.5, 14+4-7+4], corner_radius);
color("lime")translate([50,22.9-20,0])rotate([0,90,0])translate([-10+5,-30,-44])rounded_cube([20-10, 68.5, 19], corner_radius);
}
/*
*/
...
module slotdie_t_13wider(sc){
difference(){
union(){
//slotdie (l,w,h,innerrad,tankwidth,slit,block2,internalshift)
//slotdie(60,18,12,3,(13),0.2,12.5,20);
slotdie(60, 24, 12, 3, 13, 0.2, 18.5, 20);
}
...
module linearactuator_finger_airknife(){
import("linearactuator_rack_stub.stl");
/*
difference(){
union(){
translate([280+5+10+32,420,323.5+1.5-3])cube([12,8,7+3]);
}
translate([280+4+78+5.3,430,323.5+1.5-80])cylinder(d=3.5,h=100,$fn=100);
translate([280+4+78+5.3-38*2,430,323.5+1.5-80])cylinder(d=3.5,h=100,$fn=100);
//translate([-2,4.5+38,-30])cylinder(d=3.2,h=100,$fn=100);
...
module linearactuator_pipette_holder_1by1pipette_luerlock_18mm_slotdie(){
difference(){
//import("linearactuator_rack_stub.stl");
//a=[11.2,11.9,11.2,11.2];
/*
...
translate([400-70+4.5,426.5,330-3])rotate([0,0,-90]){
translate([0,0,-13]){
translate([-0.5-1,-0.7,0])rotate([0,180,180])pipette_holder_1by1tip_luerlock_slotdie();
}
}
}
//translate([0,0,-9])import("linearactuator_rack_stub.stl");
...
module pipette_holder_1by1tip_luerlock_slotdie(){
$fn = 50; // Increase $fn for smoother curves
...
translate([0+1,4.5,3])rounded_box_minkowski(size = [10+4, 20+2+6.5+6+15+19+20, 13], radius = 2, center = true);
*/
translate([0-6-5,8.5,3])rounded_box_minkowski(size = [10+4+12, 20+2+6.5+6+15+19+20-60, 13], radius = 2, center = true);
translate([0-5,8.5,3])rounded_box_minkowski(size = [10+4+12, 20+2+6.5+6+15+19+20-60, 13], radius = 2, center = true);
translate([0+1-5,8.5,3])rounded_box_minkowski(size = [10+4+12, 20+2+6.5+6+15+19+20-60, 13], radius = 2, center = true);
...
translate([14-6,0-2,17.8-18])rotate([0,90,0]){
l = 26;
translate([0,-10,-13])for(i=[2]){
//translate([0,-5.8+18*i-4.9,-21.4])cylinder(d=1.7,h=l,$fn=100);
translate([0,-5.8+18*i-4.9+25,-21.4+22])rotate([90,0,0])cylinder(d=1.7,h=l,$fn=100);
translate([0,-5.8+18*i-4.9+25,-21.4+22-13])rotate([90,0,0])cylinder(d=1.7,h=l,$fn=100);
}
}
}
}
