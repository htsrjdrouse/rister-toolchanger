...
include <../mantis_comp.scad>

//translate([48-4,32,-9])rotate([0,90,90])mantis_claw_assy();
//translate([48-4,32+20,-9])rotate([0,90,0])mantis_claw_assy();
...
translate([312-10,410-13-9.6,320-25.6-14])rotate([0,0,-0]){
#translate([2,10,-1+10])rotate([90,0,0])cylinder(d=0.19*25.4,h=0.17*25.4+12,$fn=30);
#translate([17,10,-1])rotate([90,0,0])cylinder(d=0.19*25.4,h=0.17*25.4+12,$fn=30);
}
}

translate([312,410-13,320-35])rotate([90,0,0])color("silver")difference(){
cylinder(d=0.62*25.4,h=0.17*25.4,$fn=30);
translate([0,0,-1])cylinder(d=0.19*25.4,h=0.17*25.4+12,$fn=30);
translate([0,20,-1])cylinder(d=0.19*25.4,h=0.17*25.4+12,$fn=30);
}
...
translate([50.813-7.7-1-28,-55.8-2,70-0.95-10+4+51])cube([11.3+20+4-22+28,46-26+18,10-3]);
}

translate([0,4,0]){
translate([50.813-7.7-1-28+8.5,-55.8-2+8.5,70-0.95-10+4+41])cylinder(d=2.8,h=50,$fn=30);
translate([50.813-7.7-1-28+8.5,-55.8-2+8.5+22.5,70-0.95-10+4+41])cylinder(d=2.8,h=50,$fn=30);
translate([50.813-7.7-1-28+8.5+19.3,-55.8-2+8.5+22.5/2,70-0.95-10+4+41])cylinder(d=2.8,h=50,$fn=30);
}

translate([50.813-10-11.5,-55.8-2-20-2+21,70-0.95-6-46])cube([11.3+10,46+2-30+16,70-6.2+10]);
...
translate([-14,-4.5,-12-20+15])cylinder(r=10.15/2,h=11.8,$fn=300);
...
translate([-14,27.5,-12-20+10])cylinder(r=10.15/2,h=16.8,$fn=300);
