...
//include <most_compact_gripper/compact_gripper.scad>
include <robotarm/robotarm.scad>

translate([322,658,365])rotate([0,0,180]){
//translate([48-4,32,-9])rotate([0,90,90])mantis_claw_assy();
//translate([48-4,32,-9])rotate([0,90,90])
//pantilt_small_gripper();
translate([24,80,100])rotate([0,180,0])robotarm();
lineux_backplate_for_linearactuator_modified();

translate([-250-6.5,-322,-352])cutter();
}
