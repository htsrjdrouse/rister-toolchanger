...
difference(){
union(){
translate([0+27,-10+3.2,4.25]) translate([(-floor(n5/2)-floor(n1/2)+$t+n1/2-1/2), -height-backboard_height-d1-mm_per_tooth, 0]) rotate([0,0,0]) color("pink")cube([25,3,10]);
translate([0+27,-10+3.2,4.25]) translate([(-floor(n5/2)-floor(n1/2)+$t+n1/2-1/2), -height-backboard_height-d1-mm_per_tooth, 0]) rotate([0,0,0]) color("pink")cube([25,4.5,10]);
}
for(i=[0:8]){
translate([0-4,-10+3.2+5,4.25+i*0.5]) translate([(-floor(n5/2)-floor(n1/2)+$t+n1/2-1/2), -height-backboard_height-d1-mm_per_tooth, 0]) rotate([0,90,0]) cylinder(r=4/2,h=60,$fn=30);
}
}
