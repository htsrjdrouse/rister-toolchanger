...
// Modified by Richard for shallow bubble trap containers
// Version 1.8.1-shallow
...
// inner height (for outer dimension add 2x wall thickness) - for shallow bubble traps, set this to thread_height + desired clearance (e.g., 4.33 for 3.33mm thread + 1mm)
height=4.33+2;
...
// Original line: function height()=max(2*(thread_height+bottom_thick),height);
